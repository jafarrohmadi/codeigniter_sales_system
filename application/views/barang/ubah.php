							...
							<div class="card-body">
								<form action="<?= base_url('barang/proses_ubah/' . $barang->kode_barang) ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6">
											<label for="kategori_barang"><strong>Kategori</strong></label>
											<select name="kategori_barang" id="kategori_barang" class="form-control" required>
												<option value="">-- Silahkan Pilih --</option>
												<option value="Alat Make Up" <?= $barang->kategori_barang == 'Alat Make Up' ? 'selected' : '' ?>>Alat Make Up</option>
												<option value="Alat Mandi" <?= $barang->kategori_barang == 'Alat Mandi' ? 'selected' : '' ?>>Alat Mandi</option>
												<option value="Kebutuhan Rumah" <?= $barang->kategori_barang == 'Kebutuhan Rumah' ? 'selected' : '' ?>>Kebutuhan Rumah</option>
											</select>
										</div>
									</div>
									</div>
